    ...
    <AuthLayout title="Advertiser Registration">
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="pt-6 border-t border-slate-200">
                <h3 class="text-base font-semibold text-slate-900 mb-4">Company Information</h3>

                <div class="space-y-4">
                    <div>
                        <label for="company_name" class="block text-sm font-medium text-slate-700">
                            Company Name *
                        </label>
                        <div class="mt-2">
                            <input
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            ></textarea>
                            <p class="mt-1 text-xs text-slate-400">This will help affiliates understand your brand and offerings</p>
            ...
            <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-700">What happens next?</h3>
