            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            <div v-for="(variant, vi) in form.variants" :key="vi"
...
// Variants
const addVariant = () => {
    form.variants.push({ name: '', options: {}, price: null, compare_at_price: null, stock_quantity: null, sku: '', is_active: true });
};
...
const submit = () => {
    form.post(route('advertiser.store.products.store', props.store.id), {
        onSuccess: () => {},
        transform: (data) => {
            const formData = { ...data };
