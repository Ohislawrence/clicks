<template>
    <AppLayout title="Create Store Theme">
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Create Store Theme</h2>
                    <p class="mt-1 text-sm text-gray-600">Define a new theme template for stores</p>
                </div>
...
const submit = () => {
    form.post(route('admin.store-themes.store'));
};
</script>
