...
const adminNavItems = [
    ...
    { name: 'CRM', route: 'admin.crm.index', match: 'admin.crm.*', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    ...
    { name: 'Platform Spread', route: 'admin.spread.index', match: 'admin.spread.*', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    { name: 'Wallets', route: 'admin.wallets.index', match: 'admin.wallets.*', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
    { name: 'Advertiser Payouts', route: 'admin.advertiser-payouts.index', match: 'admin.advertiser-payouts.*', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Store Refunds', route: 'admin.store-refunds.index', match: 'admin.store-refunds.*', icon: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6' },
    { name: 'LMS Courses', route: 'admin.lms.courses.index', match: 'admin.lms.*', icon: 'M9.663 17h4.673M12 3v1M6.343 6.343l-.707-.707M3 12H2m19 0h-1M6.343 17.657l-.707.707m11.657-11.314l-.707-.707M18 12a6 6 0 11-12 0 6 6 0 0112 0z' }
];
