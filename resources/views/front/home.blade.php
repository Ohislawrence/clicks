...
@section('title', config('app.name') . ' — Performance Marketing Platform | CPA Network')
@section('meta_description', 'Join the leading performance marketing platform trusted by 15,000+ affiliates and 500+ advertisers. Real-time tracking, fraud protection, weekly payments. Start earning today!')
@section('meta_keywords', 'affiliate marketing platform, CPA network, performance marketing, affiliate network, CPA offers, affiliate program, advertiser network, commission tracking, affiliate dashboard')

@section('og_title', config('app.name') . ' — Performance Marketing That Achieves Results')
@section('og_description', 'Connect with top-performing affiliates and advertisers. Advanced tracking, real-time analytics, and dedicated support to grow your business.')

@section('twitter_title', config('app.name') . ' — Performance Marketing Platform')
@section('twitter_description', 'Join 15,000+ marketers earning with exclusive offers. Real-time tracking, weekly payments, and 24/7 support.')
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="animate-fade-in-up delay-400 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('front.for-affiliates') }}" class="group btn-primary inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-semibold text-base">
                    I'm an Affiliate
                    <svg class="w-4 h-4 transition-transform group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
                </a>
                <a href="{{ route('front.for-advertisers') }}" class="group btn-secondary inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-semibold text-base">
                    I'm an Advertiser
                </a>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div class="order-2 lg:order-1">
                <div class="space-y-6">
                    ...
                    <div class="pt-4">
                        <a href="{{ route('front.for-affiliates') }}" class="group inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-semibold transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div class="order-2">
                <div class="space-y-6">
                    ...
                    <div class="pt-4">
                        <a href="{{ route('front.for-advertisers') }}" class="group inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-semibold transition-colors">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <a href="{{ route('register.affiliate') }}" class="btn-primary inline-flex items-center justify-center px-8 py-3.5 rounded-lg font-semibold text-base">
                    Sign Up as Affiliate
                </a>
                <a href="{{ route('register.advertiser') }}" class="btn-secondary inline-flex items-center justify-center px-8 py-3.5 rounded-lg font-semibold text-base">
