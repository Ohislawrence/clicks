...
<script type="application/ld+json">
{
  ...
  "url": "{{ url('/') }}",
  "logo": "{{ asset('logo/full-white.png') }}",
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="mb-10 max-w-md leading-relaxed" style="font-size:17px;color:var(--ash);font-weight:300;">
                    Stop wasting budget on fake clicks. {{ config('app.name') }} gives advertisers real-time fraud scoring and affiliates Naira payouts - built for the Nigerian market from day one.
                </p>

                {{-- CTAs --}}
                <div class="flex flex-wrap gap-4 mb-14">
                    <a href="{{ route('register') }}" class="btn-em">
                        Start earning free
                    ...
                    <a href="{{ route('front.for-advertisers') }}" class="btn-ghost-em">
                        I'm an advertiser
                    </a>
                </div>
            ...
            <div class="hidden lg:block reveal">
                <div class="mock-wrap">
                    <div class="mock-bar">
                        ...
                        <span style="font-size:11px;color:var(--stone);margin-left:10px;font-family:var(--fb);">{{ config('app.name') }} - Affiliate Dashboard</span>
...
{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     SECTION 2 Â· TICKER - Social proof
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
        ...
        <div class="flex" style="overflow:hidden;">
            <div class="ticker-track">
                ...
                <div class="flex items-center gap-3 px-8" style="border-right:1px solid var(--wire);flex-shrink:0;">
                    ...
                    <span style="font-size:11px;color:var(--em);font-family:var(--fd);font-weight:700;">{!! $tick[1] !!}</span>
...
<section class="section py-28" aria-label="Problem statement">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="card-lift reveal" style="background:var(--ink-2);border:1px solid var(--wire);border-radius:14px;padding:28px;transition-delay:{{ $i * 80 }}ms;">
                ...
                <div style="font-family:var(--fd);font-size:32px;font-weight:800;color:var(--em);line-height:1;margin-bottom:6px;">{{ $card['stat'] }}</div>
                <div style="font-size:11px;color:var(--stone);letter-spacing:0.06em;margin-bottom:20px;">{{ $card['stat_label'] }}</div>
                <hr class="sep mb-5">
                <h3 style="font-family:var(--fd);font-size:17px;font-weight:700;color:var(--snow);margin-bottom:10px;">{{ $card['title'] }}</h3>
                <p style="font-size:14px;color:var(--ash);line-height:1.75;font-weight:300;">{{ $card['body'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
            ...
            <div class="reveal">
                ...
                <div style="display:flex;flex-direction:column;gap:0;">
                    ...
                    <div style="display:flex;gap:20px;padding:24px 0;{{ $i > 0 ? 'border-top:1px solid var(--wire);' : '' }}">
                        ...
                        <div>
                            <div style="font-family:var(--fd);font-size:16px;font-weight:700;color:var(--snow);margin-bottom:6px;">{{ $step[1] }}</div>
                            <div style="font-size:14px;color:var(--ash);line-height:1.75;font-weight:300;">{!! $step[2] !!}</div>
                        </div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="mock-wrap mb-5">
                    ...
                    <div style="padding:24px;">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 0;{{ !$loop->last ? 'border-bottom:1px solid var(--wire);' : '' }}">
                            ...
                            <span style="font-size:12px;color:{{ $check[2] ? 'var(--em)' : '#f59e0b' }};font-weight:500;">{!! $check[1] !!}</span>
                        </div>
                        @endforeach
...
<section class="section py-28" aria-label="For affiliates">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="card-lift reveal" style="background:var(--ink-2);border:1px solid var(--wire);border-radius:14px;padding:28px;transition-delay:{{ ($i % 3) * 60 }}ms;">
                <div style="font-size:28px;margin-bottom:16px;" aria-hidden="true">{!! $feat[0] !!}</div>
                <h3 style="font-family:var(--fd);font-size:16px;font-weight:700;color:var(--snow);margin-bottom:10px;">{!! $feat[1] !!}</h3>
                <p style="font-size:14px;color:var(--ash);line-height:1.75;font-weight:300;">{!! $feat[2] !!}</p>
            </div>
            @endforeach
        </div>
        {{-- Tier table --}}
                ...
                <div class="overflow-x-auto">
                    <table style="width:100%;border-collapse:collapse;" aria-label="Affiliate tier comparison">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom:1px solid var(--wire);">
                                <td style="padding:16px 28px;font-size:14px;font-weight:500;color:var(--snow);">{{ $tier[0] }}</td>
                ...
                <div class="mock-wrap">
                    ...
                    <div style="padding:20px;">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid var(--wire);">
                            <div>
                                <div style="font-size:12px;color:var(--snow);font-weight:500;">{{ $offer[0] }}</div>
                                <div style="font-size:10px;color:var(--stone);">{!! $offer[1] !!} &middot; {{ $offer[2] }}</div>
                            </div>
                            <div style="font-size:11px;color:var(--em);background:rgba(16,185,129,0.1);padding:3px 9px;border-radius:20px;">{{ $offer[3] }} quality</div>
                        </div>
                        @endforeach
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="card-lift reveal" style="background:var(--ink-2);border:1px solid var(--wire);border-radius:12px;padding:22px;position:relative;">
                ...
                <div style="font-family:var(--fd);font-size:14px;font-weight:700;color:var(--snow);margin-bottom:6px;">{!! $cat[1] !!}</div>
                <div style="font-size:12px;color:var(--em);">{!! $cat[2] !!}</div>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="section py-28" style="background:var(--ink-2);border-top:1px solid var(--wire);" aria-label="Testimonials">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="card-lift reveal" style="background:var(--ink-3);border:1px solid var(--wire);border-radius:14px;padding:28px;transition-delay:{{ $i * 80 }}ms;">
                <div class="quote-mark" style="margin-bottom:16px;" aria-hidden="true">"</div>
                <blockquote>
                    <p style="font-size:14px;color:var(--ash);line-height:1.85;font-weight:300;margin-bottom:24px;font-style:italic;">{!! $test['quote'] !!}</p>
                </blockquote>
                <hr class="sep mb-4">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                    <div>
                        <div style="font-size:14px;font-weight:500;color:var(--snow);">{{ $test['name'] }}</div>
                        <div style="font-size:12px;color:var(--stone);margin-top:2px;">{!! $test['role'] !!}</div>
                    </div>
                    <div style="text-align:right;">
                        <div style="font-family:var(--fd);font-size:14px;font-weight:700;color:var(--em);">{!! $test['stat'] !!}</div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="card-lift reveal" style="background:var(--ink-2);border:1px solid var(--wire);border-radius:14px;padding:24px;">
                ...
                <div style="font-family:var(--fd);font-size:15px;font-weight:700;color:var(--snow);margin-bottom:8px;">{{ $trust[1] }}</div>
                <p style="font-size:13px;color:var(--ash);line-height:1.75;font-weight:300;">{{ $trust[2] }}</p>
            </div>
            @endforeach
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div style="background:var(--ink-3);border:1px solid var(--wire-s);border-radius:20px;padding:clamp(40px,6vw,80px);text-align:center;" class="reveal">
            ...
            <p style="font-size:17px;color:var(--ash);max-width:540px;margin:0 auto 40px;font-weight:300;line-height:1.75;">
                Join thousands of Nigerian affiliates and advertisers already earning and growing on {{ config('app.name') }}.
            </p>
            <div class="flex flex-wrap gap-4 justify-center mb-14">
                <a href="{{ route('register') }}?type=affiliate" class="btn-em" style="padding:16px 36px;font-size:15px;">
                    Join as affiliate - it's free
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden="true">
                        <path d="M3 7.5h9M8 4l3.5 3.5L8 11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
                <a href="{{ route('register') }}?type=advertiser" class="btn-ghost-em" style="padding:15px 36px;font-size:15px;">
                    Post an offer as advertiser
                </a>
            </div>
            <div class="flex flex-wrap justify-center gap-8">
                @foreach(['No setup fees','Same-day approval','Naira payouts','Cancel anytime'] as $trust)
                <div style="display:flex;align-items:center;gap:7px;">
                    ...
                    <span style="font-size:13px;color:var(--stone);">{{ $trust }}</span>
                </div>
                @endforeach
            </div>
        </div>
