...
<section class="bg-neutral-950 border-b border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-neutral-900 border border-neutral-800 rounded-full px-4 py-1.5 mb-5">
                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                <span class="text-xs font-semibold uppercase tracking-wider text-neutral-400">{{ $category->name }}</span>
            </div>
            ...
            <div class="lg:col-span-3">
                ...
                @else
                    <div class="blog-card p-12 text-center">
                        ...
                        <p class="text-neutral-400 text-lg">No posts in this category yet.</p>
                        <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 mt-4 text-emerald-400 hover:text-emerald-300 transition-colors">
