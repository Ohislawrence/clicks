...
@section('meta_description', $category->description ?: 'Browse articles in ' . $category->name . ' category.')
@section('meta_keywords', 'affiliate marketing, ' . strtolower($category->name) . ', CPA')
...
<section class="bg-slate-50 border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-white border border-slate-200 rounded-full px-4 py-1.5 mb-5">
                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-600">{{ $category->name }}</span>
            </div>
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 mb-4">
                {{ $category->name }}
            </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3">
                ...
                @else
                    <div class="blog-card p-12 text-center">
                        ...
                        <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 mt-4 text-emerald-600 hover:text-emerald-500 transition-colors">
            ...
            <aside class="lg:col-span-1 space-y-6">
                ...
                <div class="category-sidebar p-5">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('blog.index') }}" class="category-link {{ request()->routeIs('blog.index') ? 'active' : '' }}">
                                <span>All Posts</span>
                                <span class="category-count">{{ $totalPosts ?? $categories->sum('published_posts_count') }}</span>
                            </a>
                        </li>
                            ...
                            <li>
                                <a href="{{ route('blog.category', $cat->slug) }}"
                                   class="category-link {{ $cat->id === $category->id ? 'active' : '' }}">
                                    <span>{{ $cat->name }}</span>
                                    <span class="category-count">{{ $cat->published_posts_count }}</span>
                                </a>
                            </li>
                        @endforeach
                    </ul>
