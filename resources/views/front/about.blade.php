...
@section('title', 'About Us - Our Mission & Values | ' . config('app.name'))
@section('meta_description', 'Learn about ' . config('app.name') . ' - founded in 2020, serving 15,000+ affiliates and 500+ advertisers worldwide. Our mission: transparent, efficient performance marketing.')
@section('meta_keywords', 'about us, company history, our mission, our values, performance marketing company, CPA network, affiliate marketing company')

@section('og_title', 'About ' . config('app.name') . ' - Trusted Performance Marketing Platform')
@section('og_description', 'Empowering digital marketers since 2020. Transparent tracking, fair business practices, and innovative technology.')
...
<style>
    ...
    .stat-item { background:#ffffff; border:1px solid #e2e8f0; border-radius:12px;
        transition:border-color .2s ease; }
    .stat-item:hover { border-color:#cbd5e1; }
    .value-card { transition:border-color .2s ease, transform .2s ease; }
    .value-card:hover { border-color:var(--em) !important; transform:translateY(-2px); }
...
<!-- Hero Section -->
<section class="about-hero bg-white border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-4 py-1.5 mb-6">
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-700">About Us</span>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="stat-item rounded-xl p-5 text-center">
                ...
                <div class="text-sm text-slate-400 font-medium uppercase tracking-wide">Advertisers</div>
            </div>
            <div class="stat-item rounded-xl p-5 text-center">
                <div class="text-3xl md:text-4xl font-bold text-slate-900 mb-1">2,000+</div>
                <div class="text-sm text-slate-400 font-medium uppercase tracking-wide">Active Campaigns</div>
            </div>
            <div class="stat-item rounded-xl p-5 text-center">
                <div class="text-3xl md:text-4xl font-bold text-slate-700 mb-1">?48B+</div>
                <div class="text-sm text-slate-400 font-medium uppercase tracking-wide">Total Paid Out</div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div class="reveal">
                <div class="inline-flex items-center gap-2 mb-4">
                    <span class="text-sm font-semibold uppercase tracking-wider text-slate-700/80">Our Story</span>
                </div>
                <h2 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-5">
                    Built for the modern<br />marketer
                </h2>
                <div class="space-y-4 text-slate-500 leading-relaxed">
                    <p>
                        Founded in 2020, {{ config('app.name') }} emerged from a simple vision: to create a transparent,
            ...
            <div class="reveal">
                <div class="bg-slate-50 border border-slate-200 rounded-2xl p-8">
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <span class="text-sm font-medium text-slate-600">Our Mission</span>
                    </div>
...
<section class="py-20 bg-slate-50 border-t border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white border border-slate-200 rounded-xl p-6 reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Technology First</h3>
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Transparency</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Quality Focus</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Dedicated Support</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-12">
            <div class="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-4 py-1.5 mb-4">
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-700">Core Values</span>
            </div>
            <h2 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-4">
                What we believe in
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="value-card bg-slate-50 border border-slate-200 rounded-xl p-6 text-center reveal">
            ...
            <div class="value-card bg-slate-50 border border-slate-200 rounded-xl p-6 text-center reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Innovation</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
            ...
            <div class="value-card bg-slate-50 border border-slate-200 rounded-xl p-6 text-center reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Integrity</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
            ...
            <div class="value-card bg-slate-50 border border-slate-200 rounded-xl p-6 text-center reveal">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Partnership</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-slate-50 border border-slate-200 rounded-2xl p-10 md:p-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') . '?type=affiliate' }}" class="inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white px-8 py-3.5 rounded-lg font-semibold transition-all duration-200">
                    Join as Affiliate
                </a>
                <a href="{{ route('register') . '?type=advertiser' }}" class="inline-flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-slate-900 px-8 py-3.5 rounded-lg font-semibold border border-slate-200 transition-all duration-200">
                    Join as Advertiser
                </a>
            </div>
