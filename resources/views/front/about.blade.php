...
<style>
    ...
    .stat-item { background:var(--ink-2); border:1px solid var(--wire); border-radius:12px;
        transition:border-color .2s ease; }
    .stat-item:hover { border-color:var(--wire-s); }
...
<section class="py-12 bg-neutral-900 border-y border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="stat-item rounded-xl p-5 text-center">
                <div class="text-3xl md:text-4xl font-bold text-emerald-400 mb-1">₦48B+</div>
...
<section class="py-20 bg-neutral-900 border-t border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-neutral-950 border border-neutral-800 rounded-xl p-6 reveal">
...
<section class="py-20 bg-neutral-950 border-t border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="value-card bg-neutral-900 border border-neutral-800 rounded-xl p-6 text-center reveal">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-10 md:p-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') . '?type=affiliate' }}" class="inline-flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3.5 rounded-lg font-semibold transition-all duration-200">
                    Join as Affiliate
                </a>
                <a href="{{ route('register') . '?type=advertiser' }}" class="inline-flex items-center justify-center bg-neutral-800 hover:bg-neutral-700 text-white px-8 py-3.5 rounded-lg font-semibold border border-neutral-700 transition-all duration-200">
                    Join as Advertiser
                </a>
            </div>
