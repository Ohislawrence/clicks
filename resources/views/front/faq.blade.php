...
<style>
    ...
    .faq-item { background:#ffffff; border:1px solid #e2e8f0; border-radius:16px;
    ...
    .category-tab { background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;
        color:#64748b; transition:background .2s ease, border-color .2s ease, color .2s ease; }
    .category-tab:hover { border-color:#cbd5e1; color:#0f172a; }
    .category-tab.active { background:#0f172a; border-color:#0f172a; color:white; }
    .info-box { background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px; }
</style>
@endpush
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-4 py-1.5 mb-6">
                <svg class="w-4 h-4 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
                </svg>
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-500">FAQ</span>
            </div>
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-5">
                Frequently Asked<br />
                <span class="text-slate-700">Questions</span>
            </h1>
...
<!-- Category Navigation -->
<section class="sticky top-16 z-40 bg-slate-50/95 backdrop-blur-sm border-b border-slate-200 py-4">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="general" class="faq-category mb-16">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-900">General Questions</h2>
            </div>

            <div class="space-y-4">
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What is {{ config('app.name') }}?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How does the platform work?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">Is there a cost to join?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
        ...
        <div id="affiliates" class="faq-category mb-16">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-900">For Affiliates</h2>
            </div>

            <div class="space-y-4">
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How do I become an affiliate?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What types of offers are available?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How do I get paid?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                    <div class="faq-answer px-5 pb-5">
                        ...
                        <ul class="list-disc list-inside text-slate-500 space-y-1 ml-2">
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What is the minimum payout?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What traffic sources are allowed?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How quickly do conversions appear?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
        ...
        <div id="advertisers" class="faq-category mb-16">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-900">For Advertisers</h2>
            </div>

            <div class="space-y-4">
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How do I create a campaign?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What payout models do you support?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                    <div class="faq-answer px-5 pb-5">
                        ...
                        <ul class="list-disc list-inside text-slate-500 space-y-1 ml-2">
                            <li><strong class="text-slate-900">CPA (Cost Per Action):</strong> Pay for completed actions (purchases, sign-ups)</li>
                            <li><strong class="text-slate-900">CPL (Cost Per Lead):</strong> Pay for qualified leads</li>
                            <li><strong class="text-slate-900">CPS (Cost Per Sale):</strong> Pay a percentage of sale value</li>
                            <li><strong class="text-slate-900">CPM (Cost Per Mille):</strong> Pay per thousand impressions</li>
                            <li><strong class="text-slate-900">RevShare:</strong> Share revenue percentage with affiliates</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How do I track conversions?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">Can I approve affiliates individually?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">How do I prevent fraud?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
        ...
        <div id="technical" class="faq-category mb-16">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-slate-900">Technical Questions</h2>
            </div>

            <div class="space-y-4">
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">Do you provide an API?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What tracking parameters can I use?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
                ...
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-900 pr-4">What is your cookie duration?</h3>
                        <svg class="chevron-icon w-5 h-5 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </div>
        ...
        <div class="info-box p-8 text-center reveal">
            <div class="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <svg class="w-7 h-7 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
                </svg>
            </div>
            <h2 class="text-2xl font-bold text-slate-900 mb-3">Still Have Questions?</h2>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('front.contact') }}" class="inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200">
                    Contact Support
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
                </a>
                <a href="#" class="inline-flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-slate-900 px-6 py-3 rounded-xl font-semibold border border-slate-200 transition-all duration-200">
                    View Documentation
                </a>
            </div>
        </div>
