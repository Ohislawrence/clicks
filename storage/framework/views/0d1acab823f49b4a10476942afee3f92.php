    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-12">
            ...
            <p class="text-lg text-neutral-400">
                We've built our platform differently â€” with you in mind.
            </p>
        </div>
...
<section class="py-20 bg-neutral-950 border-t border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-12">
            ...
            <p class="text-lg text-neutral-400">
                Our values shape everything we do â€” from product development to customer support.
            </p>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-10 md:p-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=affiliate'); ?>" class="inline-flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3.5 rounded-lg font-semibold transition-all duration-200">
                    Join as Affiliate
                </a>
                <a href="<?php echo e(route('register') . '?type=advertiser'); ?>" class="inline-flex items-center justify-center bg-neutral-800 hover:bg-neutral-700 text-white px-8 py-3.5 rounded-lg font-semibold border border-neutral-700 transition-all duration-200">
                    Join as Advertiser
                </a>
            </div>
            <p class="text-sm text-neutral-500 mt-6">
                Join in minutes â€¢ No setup fees â€¢ Cancel anytime
            </p>
        </div>
    </div>
</section>
