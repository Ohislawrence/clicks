<?php $__env->startSection('title', 'Contact Us - Get in Touch | ' . config('app.name')); ?>
<?php $__env->startSection('meta_description', 'Contact ' . config('app.name') . ' support team. Get help with your account, campaigns, or general inquiries. Available Monday-Sunday with 24-hour response time.'); ?>
<?php $__env->startSection('meta_keywords', 'contact us, customer support, help desk, contact support, get in touch, affiliate support, advertiser support'); ?>

<?php $__env->startSection('og_title', 'Contact Us - We\'re Here to Help'); ?>
<?php $__env->startSection('og_description', 'Get in touch with our support team. We typically respond within 24 hours.'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div class="fade-up" data-animate>
                <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 md:p-8">
                    ...
                    <form action="<?php echo e(route('front.contact.submit')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="input-dark w-full px-4 py-2.5 rounded-xl text-white placeholder-neutral-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="input-dark w-full px-4 py-2.5 rounded-xl text-white placeholder-neutral-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="input-dark w-full px-4 py-2.5 rounded-xl text-white placeholder-neutral-500 <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="input-dark w-full px-4 py-2.5 rounded-xl text-white placeholder-neutral-500 resize-none <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <a href="<?php echo e(route('front.faq')); ?>" class="block text-neutral-400 hover:text-emerald-400 text-sm transition-colors">Frequently Asked Questions →</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/contact.blade.php ENDPATH**/ ?>