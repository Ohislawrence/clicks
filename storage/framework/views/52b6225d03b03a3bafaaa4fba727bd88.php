<?php $__env->startSection('title', 'Terms of Service | ' . config('app.name')); ?>
<?php $__env->startSection('meta_description', 'Read the terms of service for ' . config('app.name') . '. Understand the rules, guidelines, and policies for using our performance marketing platform.'); ?>
<?php $__env->startSection('meta_keywords', 'terms of service, terms and conditions, user agreement, platform rules, legal terms'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div class="max-w-3xl">
            <div class="flex flex-wrap gap-3 mb-6">
                <span class="badge-terms">Updated: <?php echo e(date('F d, Y')); ?></span>
            ...
            <p class="text-lg text-neutral-400 leading-relaxed">
                These Terms of Service govern your access to and use of <?php echo e(config('app.name')); ?>'s platform
            ...
            <div class="lg:col-span-3">
                <div class="terms-card p-6 md:p-8">
                    <div class="prose-terms max-w-none">
                        ...
                        <p>
                            ...
                            <a href="<?php echo e(route('front.privacy')); ?>">Privacy Policy</a>, and any additional terms that apply to specific features.
                        ...
                        <p>
                            All content, trademarks, logos, and materials on our platform are owned by <?php echo e(config('app.name')); ?>
                        ...
                        <p>
                            TO THE MAXIMUM EXTENT PERMITTED BY LAW, <?php echo e(strtoupper(config('app.name'))); ?> SHALL NOT BE LIABLE FOR
                        ...
                        <p>
                            You agree to indemnify and hold harmless <?php echo e(config('app.name')); ?>, its affiliates, and personnel
                        ...
                        <p><strong>Entire Agreement:</strong> These Terms constitute the entire agreement between you and <?php echo e(config('app.name')); ?>.</p>
                        ...
                        <div class="info-box p-6 mt-4">
                            ...
                            <p class="text-neutral-400 mb-2">
                                ...
                                <a href="mailto:legal@dealsintel.com" class="text-emerald-400 hover:text-emerald-300">legal@dealsintel.com</a>
                            </p>
                ...
                <div class="mt-6 text-center">
                    <p class="text-xs text-neutral-600">
                        These Terms of Service were last updated on <?php echo e(date('F d, Y')); ?>. Previous versions are available upon request.
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/terms.blade.php ENDPATH**/ ?>