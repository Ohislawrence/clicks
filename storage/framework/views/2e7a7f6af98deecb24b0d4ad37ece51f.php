...
Platform Features - Advanced Tracking & Analytics | <?php echo e(config('app.name')); ?>
...
<script type="application/ld+json">
{
  ...
  "name": "<?php echo e(config('app.name')); ?> Platform",
...
<style>
    ...
    .feature-card { background:#ffffff; border:1px solid #e2e8f0; border-radius:20px;
        transition:transform .25s ease, border-color .25s ease; }
    .feature-card:hover { border-color:#cbd5e1; transform:translateY(-4px); }
    .feature-icon { background:rgba(15,23,42,.06); color:#0f172a; border-radius:12px;
        display:flex; align-items:center; justify-content:center; }
    .badge-feature { background:#f1f5f9; border:1px solid #e2e8f0; border-radius:9999px;
        padding:.25rem .75rem; font-size:.7rem; font-weight:500; color:#64748b; }
    .stat-bubble { background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px; }
</style>
<?php $__env->stopPush(); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-4 py-1.5 mb-6">
                ...
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-500">Platform Capabilities</span>
            </div>
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-5">
                Everything you need<br />
                <span class="text-slate-700">for performance marketing</span>
            </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="stat-bubble p-4 text-center">
                <div class="text-2xl font-bold text-slate-700 mb-1">99.9%</div>
                <div class="text-xs text-slate-400 uppercase tracking-wide">Tracking Accuracy</div>
            </div>
            <div class="stat-bubble p-4 text-center">
                <div class="text-2xl font-bold text-slate-900 mb-1">&lt;100ms</div>
                <div class="text-xs text-slate-400 uppercase tracking-wide">Click Response Time</div>
            </div>
            <div class="stat-bubble p-4 text-center">
                <div class="text-2xl font-bold text-slate-900 mb-1">24/7</div>
                <div class="text-xs text-slate-400 uppercase tracking-wide">Support Available</div>
            </div>
            <div class="stat-bubble p-4 text-center">
                <div class="text-2xl font-bold text-slate-900 mb-1">50B+</div>
                <div class="text-xs text-slate-400 uppercase tracking-wide">Monthly Requests</div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-2xl mx-auto mb-16">
            <div class="inline-flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-4 py-1.5 mb-4">
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-700">Core Features</span>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <div class="flex items-center justify-between mb-3">
                    <h3 class="text-xl font-bold text-slate-900">Real-Time Analytics</h3>
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Smart Link Rotation</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Advanced Fraud Protection</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Multiple Payout Models</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Detailed Reporting</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">RESTful API</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Cloud-Native Platform</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Custom Tracking Parameters</h3>
                <p class="text-slate-500 leading-relaxed">
            ...
            <div class="feature-card p-6 reveal">
                ...
                <div class="flex items-center justify-between mb-3">
                    <h3 class="text-xl font-bold text-slate-900">Platform-Managed Payments</h3>
            ...
            <div class="feature-card p-6 reveal">
                ...
                <div class="flex items-center justify-between mb-3">
                    <h3 class="text-xl font-bold text-slate-900">Sales Wallet & Payouts</h3>
                    <span class="badge-feature">Store</span>
                </div>
                <p class="text-slate-500 leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-12">
            <div class="inline-flex items-center gap-2 bg-slate-100/50 rounded-full px-4 py-1.5 mb-4">
                <span class="text-xs font-semibold uppercase tracking-wider text-slate-700">Enterprise Ready</span>
            </div>
            <h2 class="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
                Built for scale
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white border border-slate-200 rounded-xl p-6 text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Server-Side Tracking</h3>
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">Sub-Affiliate Management</h3>
                <p class="text-sm text-slate-500">
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">White-Label Solution</h3>
                <p class="text-sm text-slate-500">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-slate-50 border border-slate-200 rounded-2xl p-10 md:p-12">
            ...
            <p class="text-lg text-slate-500 mb-8 max-w-xl mx-auto">
                Join <?php echo e(config('app.name')); ?> today and take your affiliate marketing to the next level.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=affiliate'); ?>" class="inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-200">
                    Sign Up as Affiliate
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
                </a>
                <a href="<?php echo e(route('register') . '?type=advertiser'); ?>" class="inline-flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-slate-900 px-8 py-3.5 rounded-xl font-semibold border border-slate-200 transition-all duration-200">
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/features.blade.php ENDPATH**/ ?>