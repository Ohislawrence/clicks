<?php $__env->startSection('title', 'Frequently Asked Questions (FAQ) | ' . config('app.name')); ?>
<?php $__env->startSection('meta_description', 'Find answers to common questions about ' . config('app.name') . '. Learn about payments, offers, tracking, fraud protection, and how to get started as an affiliate or advertiser.'); ?>
<?php $__env->startSection('meta_keywords', 'affiliate marketing FAQ, CPA network questions, affiliate program FAQ, how to get started, payment questions, tracking questions'); ?>

<?php $__env->startSection('og_title', 'FAQ - Your Questions Answered'); ?>
<?php $__env->startSection('og_description', 'Common questions about affiliate marketing, payments, tracking, and getting started on our platform.'); ?>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is <?php echo e(config('app.name')); ?>?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "<?php echo e(config('app.name')); ?> is a performance-based affiliate marketing platform that connects advertisers with affiliates."
      }
    },
    {
      "@type": "Question",
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <div class="faq-item" data-faq>
                    <div class="faq-question p-5 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-white pr-4">What is <?php echo e(config('app.name')); ?>?</h3>
                    ...
                    <div class="faq-answer px-5 pb-5">
                        <p class="text-neutral-400 leading-relaxed">
                            <?php echo e(config('app.name')); ?> is a performance-based affiliate marketing platform that connects advertisers with affiliates.
        ...
        <div class="info-box p-8 text-center fade-up" data-animate>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('front.contact')); ?>" class="inline-flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200">
                    Contact Support
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/faq.blade.php ENDPATH**/ ?>