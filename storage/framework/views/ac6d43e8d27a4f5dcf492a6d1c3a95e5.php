...
<?php $__env->startSection('meta_description', 'Read our privacy policy to understand how ' . config('app.name') . ' collects, uses, and protects your personal information. NDPR compliant.'); ?>
<?php $__env->startSection('meta_keywords', 'privacy policy, data protection, NDPR, Nigeria Data Protection Regulation, NITDA, personal information, data security'); ?>
                    ...
                    <div class="prose-custom max-w-none">
                        ...
                        <div class="info-box p-6 mt-4 mb-6">
                            ...
                            <p class="text-neutral-400">
                                <span class="text-neutral-500">Address:</span> <?php echo e(config('app.name')); ?>, Lagos, Nigeria
                            </p>
                        </div>
