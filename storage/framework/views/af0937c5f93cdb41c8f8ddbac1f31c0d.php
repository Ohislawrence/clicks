...
<style>
    ...
    .stat-card { background:var(--ink-2); border:1px solid var(--wire); border-radius:16px; }
    .benefit-card { background:var(--ink-2); border:1px solid var(--wire); border-radius:20px;
        transition:transform .25s ease, border-color .25s ease; }
    .benefit-card:hover { border-color:var(--wire-s); transform:translateY(-4px); }
    .feature-box { background:var(--ink-2); border:1px solid var(--wire); border-radius:16px;
        transition:border-color .2s ease; }
    .feature-box:hover { border-color:var(--wire-s); }
    .step-number { background:var(--em); color:var(--ink); font-weight:700; }
    .industry-tag { background:var(--ink-2); border:1px solid var(--wire); border-radius:12px;
        transition:border-color .2s ease, transform .2s ease; }
    .industry-tag:hover { border-color:var(--em); transform:translateY(-2px); }
    .testimonial-card { background:var(--ink-2); border:1px solid var(--wire); border-radius:20px; }
</style>
<?php $__env->stopPush(); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=advertiser'); ?>" class="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 group">
                    Start Advertising
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="feature-box p-5">
                        <h3 class="font-semibold text-white mb-2">Flexible payment collection</h3>
                        <p class="text-sm text-neutral-400">Use your own Paystack or Flutterwave keys (Direct mode), or switch to Platform-Managed mode — the platform collects payments and credits your net earnings to your sales wallet automatically.</p>
                    </div>
                    <div class="feature-box p-5">
                        <h3 class="font-semibold text-white mb-2">Subscription-based pricing</h3>
                        <p class="text-sm text-neutral-400">Start with affordable store plans from â‚¦5,000 monthly. Renew manually and keep your shop live while you grow.</p>
                    </div>
                    <div class="feature-box p-5">
            ...
            <div class="bg-neutral-950 border border-neutral-800 rounded-3xl p-8">
                ...
                <div class="space-y-4">
                    <div class="p-5 bg-neutral-900 border border-neutral-800 rounded-2xl">
                        ...
                        <div class="text-2xl font-bold text-white">â‚¦5,000</div>
                        <div class="text-sm text-neutral-400">Monthly / â‚¦50,000 yearly (save 17%)</div>
                    </div>
                    <div class="p-5 bg-neutral-900 border border-neutral-800 rounded-2xl">
                        <div class="text-sm text-neutral-500">Multi-Product Bronze</div>
                        <div class="text-2xl font-bold text-white">â‚¦15,000</div>
                        <div class="text-sm text-neutral-400">Monthly / â‚¦150,000 yearly - up to 10 products</div>
                    </div>
                    <div class="p-5 bg-neutral-900 border border-neutral-800 rounded-2xl">
                        <div class="text-sm text-neutral-500">Multi-Product Silver</div>
                        <div class="text-2xl font-bold text-white">â‚¦30,000</div>
                        <div class="text-sm text-neutral-400">Monthly / â‚¦300,000 yearly - up to 50 products</div>
                    </div>
                    <div class="p-5 bg-neutral-900 border border-neutral-800 rounded-2xl">
                        <div class="text-sm text-neutral-500">Multi-Product Gold</div>
                        <div class="text-2xl font-bold text-white">â‚¦50,000</div>
                        <div class="text-sm text-neutral-400">Monthly / â‚¦500,000 yearly - up to 200 products</div>
                    </div>
                </div>
                <p class="text-sm text-neutral-500 mt-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="feature-box p-5 flex items-start gap-4 reveal">
                ...
                <div>
                    <h3 class="font-semibold text-white mb-1">Platform-Managed Payments</h3>
                    <p class="text-sm text-neutral-400">Let the platform handle store payments end-to-end. Revenue is split automatically — platform fee deducted, affiliate commission credited, and your net earnings added to your sales wallet for withdrawal.</p>
                </div>
            </div>
            <div class="feature-box p-5 flex items-start gap-4 reveal">
                <div class="text-2xl">💸</div>
                <div>
                    <h3 class="font-semibold text-white mb-1">Sales Wallet & Payouts</h3>
                    <p class="text-sm text-neutral-400">Store sales earnings accumulate in your Advertiser Sales Wallet. Request withdrawals directly to your Nigerian bank account from the advertiser portal.</p>
                </div>
            </div>        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="testimonial-card p-6 reveal">
                <div class="flex gap-1 text-emerald-400 mb-4">â˜…â˜…â˜…â˜…â˜…</div>
...
<section class="py-20 bg-neutral-900 border-t border-neutral-800">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-neutral-950 border border-neutral-800 rounded-2xl p-10 md:p-12">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=advertiser'); ?>" class="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-200 group">
                    Start Advertising
                    <svg class="w-4 h-4 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
                </a>
                <a href="<?php echo e(route('front.contact')); ?>" class="inline-flex items-center justify-center gap-2 bg-neutral-800 hover:bg-neutral-700 text-white px-8 py-3.5 rounded-xl font-semibold border border-neutral-700 transition-all duration-200">
                    Contact Sales
                </a>
            </div>
            <p class="text-sm text-neutral-500 mt-6">
