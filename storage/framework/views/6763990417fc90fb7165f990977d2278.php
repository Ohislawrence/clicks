...
<?php $__env->startSection('title', 'For Affiliates - Earn with Top CPA Offers | ' . config('app.name')); ?>
<?php $__env->startSection('meta_description', 'Join 15,000+ successful affiliates earning competitive commissions. Access 2,000+ exclusive offers, weekly payments, and dedicated support. Sign up free today!'); ?>
<?php $__env->startSection('meta_keywords', 'affiliate program, CPA offers, affiliate earnings, make money online, affiliate commissions, weekly payments, affiliate network, performance marketing for affiliates'); ?>

<?php $__env->startSection('og_title', 'Monetize Your Traffic with Premium CPA Offers'); ?>
<?php $__env->startSection('og_description', 'Exclusive campaigns, competitive payouts, and weekly payments. Join thousands of successful affiliates on ' . config('app.name') . '.'); ?>

<?php $__env->startSection('twitter_title', 'For Affiliates - Start Earning Today'); ?>
<?php $__env->startSection('twitter_description', 'Access 2,000+ exclusive offers with weekly payments. Join 15,000+ affiliates earning competitive commissions.'); ?>
...
<style>
    ...
    .vertical-card { background:var(--ink-2); border:1px solid var(--wire); border-radius:16px;
        transition:border-color .2s ease, transform .2s ease; }
    .vertical-card:hover { border-color:var(--em); transform:translateY(-2px); }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=affiliate'); ?>" class="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 group">
                    Join Now - It's Free
...
<section class="py-12 bg-neutral-900 border-y border-neutral-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="stat-card p-5 text-center reveal">
                <div class="text-3xl md:text-4xl font-bold text-emerald-400 mb-1">₦2.4B+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
                Why Affiliates Choose <?php echo e(config('app.name')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="benefit-card p-6 reveal">
                ...
                <h3 class="text-xl font-bold text-white mb-2">Earn on Advertiser Store Sales</h3>
                <p class="text-neutral-400 leading-relaxed">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-10 md:p-12">
            ...
            <p class="text-lg text-neutral-400 mb-8 max-w-xl mx-auto">
                Join <?php echo e(config('app.name')); ?> today and start monetizing your traffic with top-converting offers.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register') . '?type=affiliate'); ?>" class="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-200 group">
                    Create Free Account
                    <svg class="w-4 h-4 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                    </svg>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/for-affiliates.blade.php ENDPATH**/ ?>