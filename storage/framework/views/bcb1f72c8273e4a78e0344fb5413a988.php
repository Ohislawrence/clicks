...
<?php $__env->startSection('title', 'Store Builder for Advertisers | ' . config('app.name')); ?>
<?php $__env->startSection('meta_description', 'Create a branded online store with subscription-based storefront plans. Custom themes, direct payment integration, and order management for advertisers.'); ?>
<?php $__env->startSection('meta_keywords', 'store builder, advertiser storefront, ecommerce store builder, paystack integration, flutterwave integration, subscription plans, performance marketing'); ?>

<?php $__env->startSection('og_title', 'Store Builder for Advertisers'); ?>
<?php $__env->startSection('og_description', 'Launch custom online storefronts with product catalogs, checkout, and subscription plans directly from your advertiser dashboard.'); ?>

<?php $__env->startSection('twitter_title', 'Store Builder for Advertisers'); ?>
<?php $__env->startSection('twitter_description', 'Build your branded storefront, manage products and orders, and accept payments with Paystack or Flutterwave.'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('register.advertiser')); ?>" class="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-200">
                        Start Your Store
                    </a>
            ...
            <div class="rounded-[2rem] border border-neutral-800 bg-neutral-900 p-8">
                <div class="rounded-3xl bg-neutral-950 border border-neutral-800 p-6 space-y-6">
                    ...
                    <div class="text-neutral-400"><?php echo e(url('/store')); ?>/your-brand</div>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dealsintel\resources\views/front/store-builder.blade.php ENDPATH**/ ?>